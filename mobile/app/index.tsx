...
import { crossCheck, type CrossCheckResponse } from "@/services/api";
...
export default function HomeScreen() {
  ...
  const handleExcelDownload = async () => {
    ...
    try {
      ...
      // Upload and get file via fetch, then save
    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.logoHeader}>
          {/* 로고 파일이 있으면 아래 Image 주석을 해제하세요 */}
          {/* <Image source={require("../assets/kg-logo.png")} style={styles.logo} resizeMode="contain" /> */}
